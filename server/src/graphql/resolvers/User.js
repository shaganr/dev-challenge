import { getUser, baseConverter, getCompany } from '../../helpers';
// DONE PARTIAL todo: 5. it would be nicer to return a base62 value for the id field instead of a base16 uuid.
...
export default {
  id: async (root, args, { ctx }, info) =>
    baseConverter(root.id, 16, 62) || root.id,
  ...
  company: async (root, args, { ctx }, info) => {
    ...
    if (typeof root.company !== 'undefined') {
      // lets turn that into actual user data.
